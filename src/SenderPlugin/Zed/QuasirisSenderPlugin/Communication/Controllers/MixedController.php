...
namespace Quasiris\Zed\QuasirisSenderPlugin\Communication\Controllers;
...
class MixedController extends AbstractController { 
    ...
    public function createArrayToSend($listenerName, $eventName, $abstract, $concrete, $categories, $productId, $type) {
        $data = array(
